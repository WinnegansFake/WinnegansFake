        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3 md:col-span-1">
            <div className="flex items-center space-x-2">
              <span className="font-serif font-black text-emerald-400 text-lg">WinnegansFake</span>
            </div>
            <p className="text-slate-400 text-xs leading-relaxed">
              An open-source, zero-copyright digital apparatus and polyphonic scholarly gloss on James Joyce’s monumental <em>Finnegans Wake</em> (1939).
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/guide" className="hover:text-emerald-300 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/guide#contributing" className="hover:text-emerald-300 transition-colors">
