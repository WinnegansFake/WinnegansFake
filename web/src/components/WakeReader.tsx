...
export function UniversalReader({
  ...
  const loadPageData = async (page: number, workIdToUse?: string) => {
    ...
    if (isFW) {
      candidateUrls.push(`${basePath}/annotations/finneganswake/page_${padPage}.json`);
      candidateUrls.push(`${basePath}/annotations/finnegans-wake/page_${padPage}.json`);
      candidateUrls.push(`${basePath}/annotations/page_${padPage}.json`);
    } else {
      candidateUrls.push(`${basePath}/annotations/${activeWorkId}/page_${padPage}.json`);
    }
