import { Annotation, LineSegment } from './types.js';
 ...
 *
 * Implements greedy longest-match phrase resolution with collision prevention.
 */
export function segmentAnnotatedLine(
  ...
  const phraseMap = new Map<string, { phrase: string; annotations: Annotation[] }>();
