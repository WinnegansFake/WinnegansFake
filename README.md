...
3. **Micro-Cosmology & Sigla:** Analysis of the Buffalo Notebooks and Joyce's hieroglyphic sigla notation—∐ (HCE), Δ (ALP), [ (Shem the Penman), ] (Shaun the Post), ⊣ (Issy and the 28 Rainbow Girls), and ⊥ (Mamalujo / The Four Masters).
